...
function ConversationPanel({messages, loadingText, streamMultipleLines}) {
    ...
    // redux
    const {interviewID, inputMode, audioFilePath, audioRecordings, interviewMessages, isMessageLoading, isEnded, totalQuestion, currentProgress} = useSelector((state) => state.chat);
    // useStates
